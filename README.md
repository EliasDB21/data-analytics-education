...
![Sample composition — affiliation](images/IMAGEN2.png)
*Figure 2 — Affiliation (major field or sector).*

![Sample composition — age range](images/IMAGEN3.png)
...
![Background — programming experience by role](images/IMAGEN4.png)
*Figure 4 — Programming experience (Students vs. Professionals).*

![Background — programming experience by age × role × gender](images/IMAGEN5.png)
*Figure 5 — Programming experience broken down by age, role, and gender.*

![Background — data analytics experience by role](images/IMAGEN6.png)
*Figure 6 — Data analytics experience (Students vs. Professionals).*

![Background — tools experience (Python/Colab, etc.)](images/IMAGEN7.png)
*Figure 7 — Experience with Python/Colab and related tools.*

![Background — GenAI experience (general, programming, analytics, APIs)](images/IMAGEN8.png)
...
![Outcome — time required to finish activities (by role and approach)](images/IMAGEN9.png)
...
![Outcome — time required (variant panel, if available)](images/IMAGEN10.png)
...
![Outcome — perceived metrics by role](images/IMAGEN11.png)
*Figure 11 — Ease, Speed, Appropriateness, Correctness by role (Students vs. Professionals).*

![Outcome — perceived metrics by gender](images/IMAGEN12.png)
